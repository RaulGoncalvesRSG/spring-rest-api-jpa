...
@Profile("test") 	
/*Define a classe como uma configuração específica para o perfil de test. OBS: o nome precisa ser igual ao
  que foi definido em spring.profiles.active. Se a anotação estiver como @Profile("test"), a configuração 
  irá funcionar somente se spring.profiles.active=test no arquivo application.properties*/
public class TestConfig implements CommandLineRunner{
	...
	@Override		//Tudo que estiver dentro do método será executado quando a aplicação for iniciada
	public void run(String... args) throws Exception {
		...
		o1.setPayment(pay1);
		orderRepository.save(o1);       //Agora que o pedido possui um pagamento, salva ele novamente
	}
}
